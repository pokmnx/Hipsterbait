...
public class ConfirmArchiveActivity extends ImmersiveActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirm_archive);
        ...
        ((HBTextView) findViewById(R.id.archive_confirm_cassette_name)).setText(mName);
    }

    public void confirmTapped(View v) {
        mUser.archiveCassette(mCassetteKey);
        finish();
    }
